...
DHT dht(D4, DHTTYPE); // ganti sesuaikan pin dhtmu

const char *ssid = "KEDAI DJENGGOT $$$";                                      // nama SSID untuk koneksi Anda
const char *password = "wesmanganrungle";                                             // password akses point WIFI Anda
const uint16_t port = 9000;                                            // diganti dengan port serve Anda
const char *host = "3.83.100.253"; //diganti dengan host server Anda, bisa ip ataupun domain
